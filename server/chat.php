...
$mysql_host = "mysql5.000webhost.com"; // sql сервер
$mysql_user = "a6805356_user"; // пользователь
$mysql_password = "123pass"; // пароль
$mysql_database = "a6805356_chat"; // имя базы данных chat
